...
const SpecialHighlights: React.FC<SpecialHighlightsProps> = ({
  ...
  const getLateNightTracks = () => {
    const late = recentlyPlayed
      .filter(t => t.played_at)
      .filter(t => {
        const hr = new Date(t.played_at!).getHours();
        return hr >= 22 || hr <= 4;
      });
    const unique = Array.from(new Map(late.map(t => [t.id, t])).values());
  ...
  const handleGeneratePlaylist = async () => {
    ...
    const sorted = unique.sort((a, b) => b.popularity - a.popularity).slice(0, 50);
    ...
    try {
      const createRes = await fetch(
        `https://api.spotify.com/v1/users/${spotifyUserId}/playlists`,
        {
          ...
          body: JSON.stringify({
            ...
            public: false,
            description: 'Generated by MyVibeLytics AI tool',
          }),
        }
      );
      ...
      console.error(e);
      alert('Oops! Something went wrong creating your playlist.');
    } finally {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <FeatureCard
        ...
        description="AI-based playlist made just for you"
      ...
      <FeatureCard
        ...
        description="Your most played underrated track"
